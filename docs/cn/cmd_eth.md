...
发起 RPC 调用。 支持的方法可参考[以太坊 Json RPC 文档](https://ethereum.org/en/developers/docs/apis/json-rpc/#eth_protocolversion) 和 [Geth RPC 文档](https://geth.ethereum.org/docs/interacting-with-geth/rpc)
...
3. 发送交易。此时程序会等待，直接到收到交易 receipt。
```
