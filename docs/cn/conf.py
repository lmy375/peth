...
with Path(__file__).parent.parent.joinpath("../setup.py").open() as fp:
    for line in fp:
        if "version=" in line:
...
latex_documents = [(master_doc, "Peth.tex", "Peth Documentation", "Moon", "manual")]
...
man_pages = [(master_doc, "peth", "Peth Documentation", [author], 1)]
