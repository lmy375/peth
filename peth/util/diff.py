...
def diff_uniswap(chain, factory=None, pair=None, router=None):
    ...
    if pair:
        # UniswapV2Pair
        diff_chain_src(
            "eth", "0x0d4a11d5eeaac28ec3f61d100daf4d40471f1852", chain, pair, "uni_pair"
        )
    if router:
        # UniswapV2Router02
        diff_chain_src(
...
def diff_sushi(chain, masterchef):
    # MasterChef
    diff_chain_src(
        "eth", "0xc2EdaD668740f1aA35E4D8f227fB8E17dcA888Cd", chain, masterchef
    )
...
def diff_comp(chain, comptroller):
    ...
    diff_chain_src(
        "eth", "0xbafe01ff935c7305907c33bf824352ee5979b526", chain, comptroller
    )
